...
export const chainSummaryGenerationTitle = (
  ...
  return {
    messages: [
      {
        content: `You are a senior AI art creator and language master. You need to summarize a title based on the AI ${modal} prompt provided by the user. This title should concisely describe the core content of the creation and will be used to identify and manage this series of works. Keep it within 10 characters, no punctuation marks needed, output language: ${locale}.`,
        role: 'system',
      },
      {
        content: `Prompt:\n${formattedPrompts}`,
